"use strict";(globalThis.webpackChunk_ember_auto_import_=globalThis.webpackChunk_ember_auto_import_||[]).push([[757],{70:(e,t,i)=>{i.d(t,{A:()=>de,C:()=>Ke,I:()=>ge,M:()=>ue,S:()=>Pe,g:()=>y,i:()=>S,k:()=>he,l:()=>Re,n:()=>ye,o:()=>K,p:()=>U,q:()=>G,r:()=>W,s:()=>J,t:()=>L,u:()=>g})
var s=i(603),r=i(648),n=i(375)
Symbol("record-originated-on-client"),Symbol("identifier-bucket"),Symbol("warpDriveStaleCache")
const o=Symbol("warpDriveCache")
var a=i(241),l=i(146),c=i(223),d=i(738),h=i(193)
function u(e,t){if(t.has(e))throw new TypeError("Cannot initialize the same private elements twice on an object")}function f(e,t,i){if("function"==typeof e?e===t:e.has(t))return arguments.length<3?t:i
...
return"symbol"==typeof t?t:t+""}(t))in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}function y(e){{let t
return t=null==e||""===e?null:String(e),(0,s.deprecate)(`The resource id '<${typeof e}> ${String(e)} ' is not normalized. Update your application code to use '${JSON.stringify(t)}' instead.`,t===e,{id:"ember-data:deprecate-non-strict-id",until:"6.0",for:"ember-data",since:{available:"4.13",enabled:"5.3"}}),t}}function m(e){let t=null
return"string"==typeof e?t=e.length>0?e:null:"number"!=typeof e||isNaN(e)||(t=String(e)),t}function g(e){{const t=(0,a._k)(e)
return(0,s.deprecate)(`The resource type '${e}' is not normalized. Update your application code to use '${t}' instead of '${e}'.`,t===e,{id:"ember-data:deprecate-non-strict-types",until:"6.0",for:"ember-data",since:{available:"4.13",enabled:"5.3"}}),t}}function _(e){return Boolean(e&&"object"==typeof e)}function b(e,t){return Boolean(_(e)&&t in e&&"string"==typeof e[t]&&e[t].length)}function v(e){return b(e,"lid")}function w(e){return b(e,"id")||Boolean(_(e)&&"id"in e&&"number"==typeof e.id)}const R=(0,n.L1)("IDENTIFIERS",new Set),k=(0,n.L1)("DOCUMENTS",new Set)
function S(e){return void 0!==e[o]||R.has(e)}function A(e){return k.has(e)}const M="undefined"!=typeof FastBoot?FastBoot.require("crypto"):globalThis.crypto,C=new Map
let E=0
function T(e,t,i){"record"===i&&!e.id&&w(t)&&function(e,t,i){let s=e.get(t.type)
s||(s=new Map,e.set(t.type,s)),s.set(i,t.lid)}(C,e,t.id)}function q(e,t){const i=w(e)?y(e.id):null
return{type:function(e){return b(e,"type")}(e)?g(e.type):t?t.type:null,id:i}}function O(e,t){if("record"===t){if(v(e))return e.lid
if(w(e)){const t=g(e.type),i=C.get(t)?.get(e.id)
return i||`@lid:${t}-${e.id}`}return M.randomUUID()}if("document"===t)return e.url?e.method&&"GET"!==e.method.toUpperCase()?null:e.url:null}function D(...e){}function j(e,t,i){return e}class P{constructor(){this._generate=(0,n.Yj)("configuredGenerationMethod")||O,this._update=(0,n.Yj)("configuredUpdateMethod")||T,this._forget=(0,n.Yj)("configuredForgetMethod")||D,this._reset=(0,n.Yj)("configuredResetMethod")||D,this._merge=j,this._keyInfoForResource=(0,n.Yj)("configuredKeyInfoMethod")||q,this._id=E++,this._cache={resources:new Map,resourcesByType:Object.create(null),documents:new Map,polymorphicLidBackMap:new Map}}__configureMerge(e){this._merge=e||j}upgradeIdentifier(e){return this._getRecordIdentifier(e,2)}_getRecordIdentifier(e,t){if(S(e))return e
const i=this._generate(e,"record")
let s=F(this._cache,i)
if(null!==s)return s
if(0!==t){if(2===t)e.lid=i,e[o]=this._id,s=N(e)
else{const t=this._keyInfoForResource(e,null)
t.lid=i,t[o]=this._id,s=N(t)}return I(this._cache,s),s}}peekRecordIdentifier(e){return this._getRecordIdentifier(e,0)}getOrCreateDocumentIdentifier(e){let t=e.cacheOptions?.key
if(t||(t=this._generate(e,"document")),!t)return null
let i=this._cache.documents.get(t)
return void 0===i&&(i={lid:t},k.add(i),this._cache.documents.set(t,i)),i}getOrCreateRecordIdentifier(e){return this._getRecordIdentifier(e,1)}createIdentifierForNewRecord(e){const t=this._generate(e,"record"),i=N({id:e.id||null,type:e.type,lid:t,[o]:this._id})
...
if(null!==n&&n===r&&i===o&&v(s)&&s.lid!==a)return F(e,s.lid)||!1
if(null!==n&&n===r&&i&&i!==o&&v(s)&&s.lid===a){const t=e.resourcesByType[i],s=t&&t.id.get(r)
...
i=this._mergeRecordIdentifiers(s,e,r,t),n&&(t.lid=i.lid)}const o=i.id;(function(e,t,i,s){s(e,i,"record"),void 0!==i.id&&(e.id=y(i.id))})(i,0,t,this._update)
const a=i.id
...
s&&(s.forEach((e=>{this._cache.resources.delete(e)})),this._cache.polymorphicLidBackMap.delete(t.lid)),t[o]=void 0,R.delete(t),this._forget(t,"record")}destroy(){C.clear(),this._cache.documents.forEach((e=>{k.delete(e)})),this._reset()}}function N(e,t,i){return R.add(e),e}function F(e,t,i){return e.resources.get(t)||null}function I(e,t){e.resources.set(t.lid,t)
let i=e.resourcesByType[t.type]
i||(i={lid:new Map,id:new Map},e.resourcesByType[t.type]=i),i.lid.set(t.lid,t),t.id&&i.id.set(t.id,t)}class ${constructor(e,t){p(this,"___token",void 0),p(this,"___identifier",void 0),this.store=e,this.___identifier=t,this.___token=e.notifications.subscribe(t,((e,t,i)=>{("identity"===t||"attributes"===t&&"id"===i)&&this._ref++}))}destroy(){this.store.notifications.unsubscribe(this.___token)}get type(){return this.identifier().type}id(){return this._ref,this.___identifier.id}identifier(){return this.___identifier}remoteType(){return"identity"}push(e){return Promise.resolve(e).then((e=>this.store.push(e)))}value(){return this.store.peekRecord(this.___identifier)}load(){const e=this.id()
...
function L(e,t){z.set(e,t)}function B(e){z.delete(e)}function U(e){return z.has(e)?z.get(e):null}const V=(0,n.L1)("RecordCache",new Map)
function H(e){return V.get(e)}function W(e){return V.get(e)}function K(e,t){V.set(e,t)}const G=(0,n.L1)("StoreMap",new Map)
function J(e){return G.get(e)}class Y{constructor(e){p(this,"__instances",{record:new Map,reference:new WeakMap}),this.store=e,this._storeWrapper=new x(this.store),e.identifierCache.__configureMerge(((e,t,i)=>{let s=e
...
r&&e.call(t,s,r)}}))}}const ee=new Set(["added","removed","state","updated","invalidated"])
function te(e){return ee.has(e)}function ie(){return!!c._backburner.currentInstance&&!0!==c._backburner._autorun}class se{constructor(e){this.store=e,this.isDestroyed=!1,this._buffered=new Map,this._hasFlush=!1,this._cache=new Map,this._tokens=new Map}subscribe(e,t){let i=this._cache.get(e)
i||(i=new Map,this._cache.set(e,i))
const s={}
return i.set(s,t),this._tokens.set(s,e),s}unsubscribe(e){this.isDestroyed||function(e,t,i){const s=e.get(t)
if(s){e.delete(t)
const r=i.get(s)
r?.delete(t)}}(this._tokens,e,this._cache)}notify(e,t,i){if(!S(e)&&!A(e))return!1
const s=Boolean(this._cache.get(e)?.size)
if(te(t)||s){let s=this._buffered.get(e)
...
this._hasFlush&&!1!==e&&!ie()||(!e||ie()?this._flush():this._hasFlush=!0)}_flush(){const e=this._buffered
e.size&&(this._buffered=new Map,e.forEach(((e,t)=>{e.forEach((e=>{this._flushNotification(t,e[0],e[1])}))}))),this._hasFlush=!1,this._onFlushCB?.(),this._onFlushCB=void 0}_flushNotification(e,t,i){if(te(t)){const i=this._cache.get(A(e)?"document":"resource")
i&&i.forEach((i=>{i(e,t)}))}const s=this._cache.get(e)
return!(!s||!s.size||(s.forEach((s=>{s(e,t,i)})),0))}destroy(){this.isDestroyed=!0,this._tokens.clear(),this._cache.clear()}}const re=Proxy,ne=new Set([Symbol.iterator,"concat","entries","every","fill","filter","find","findIndex","flat","flatMap","forEach","includes","indexOf","join","keys","lastIndexOf","map","reduce","reduceRight","slice","some","values"]),oe=new Set(["push","pop","unshift","shift","splice","sort"]),ae=new Set(["[]","length","links","meta"])
function le(e){return ne.has(e)}function ce(e,t){return t in e}const de=(0,n.L1)("#signal",Symbol("#signal")),he=(0,n.L1)("#source",Symbol("#source")),ue=(0,n.L1)("#update",Symbol("#update")),fe=(0,n.L1)("#notify",Symbol("#notify")),pe=(0,n.L1)("IS_COLLECTION",Symbol.for("Collection"))
function ye(e){(0,l.RH)(e[de])}function me(e){if("symbol"==typeof e)return null
const t=Number(e)
return isNaN(t)?null:t%1==0?t:null}class ge{[fe](){ye(this)}destroy(e){this.isDestroying=!e,this[he].length=0,this[fe](),this.isDestroyed=!e}get length(){return this[he].length}set length(e){this[he].length=e}constructor(e){p(this,"isLoaded",!0),p(this,"isDestroying",!1),p(this,"isDestroyed",!1),p(this,"_updatingPromise",null),p(this,pe,!0),p(this,he,void 0)
const t=this
this.modelName=e.type,this.store=e.store,this._manager=e.manager,this[he]=e.identifiers,this[de]=(0,l.n5)(this,"length")
const i=e.store,s=new Map,r=this[de],n={links:e.links||null,meta:e.meta||null}
let o=!1
const a=new re(this[he],{get(a,c,d){const h=me(c)
if(r.shouldReset&&(null!==h||ae.has(c)||le(c))&&(e.manager._syncArray(d),r.t=!1,r.shouldReset=!1),null!==h){const e=a[h]
...
return o=!1,e},s.set(c,e)),e}if(function(e){return oe.has(e)}(c)){let i=s.get(c)
return void 0===i&&(i=function(){if(!e.allowMutation)return
const i=Array.prototype.slice.call(arguments)
o=!0
const s=t[ue](a,d,c,i,r)
return o=!1,s},s.set(c,i)),i}if(ce(t,c)){if(c===fe||c===de||c===he)return t[c]
let e=s.get(c)
if(e)return e
const i=t[c]
return"function"==typeof i?(e=function(){return(0,l.B1)(r),Reflect.apply(i,d,arguments)},s.set(c,e),e):((0,l.B1)(r),i)}return a[c]},set(i,s,a,l){if("length"===s){if(!o&&0===a)return o=!0,t[ue](i,l,"length 0",[],r),o=!1,!0
...
return i[c]=e,!0}return!!ce(t,s)&&(t[s]=a,!0)}if(!e.allowMutation)return!1
const d=i[c],h=(u=a)?W(u):null
var u
return o?i[c]=h:t[ue](i,l,"replace cell",[c,d,h],r),!0},deleteProperty:(e,t)=>!!o&&Reflect.deleteProperty(e,t),getPrototypeOf:()=>ge.prototype})
...
void 0!==s.initializer&&(s.value=s.initializer?s.initializer.call(e):void 0,s.initializer=void 0),Object.defineProperty(e,t,s)}(ge.prototype,"length",[d.Vv])
const _e={enumerable:!0,configurable:!1,get:function(){return this}};(0,d.Vv)(_e),Object.defineProperty(ge.prototype,"[]",_e),(0,l.sg)(ge.prototype,"isUpdating",!1)
class be extends ge{constructor(e){super(e),p(this,"query",null),this.query=e.query||null,this.isLoaded=e.isLoaded||!1}_update(){const{store:e,query:t}=this
...
const ve=(0,n.L1)("FAKE_ARR",{}),we=1200
function Re(e,t){let i=0
const s=t.length
for(;s-i>we;)e.push.apply(e,t.slice(i,i+we)),i+=we
e.push.apply(e,t.slice(i))}class ke{constructor(e){this.store=e.store,this.isDestroying=!1,this.isDestroyed=!1,this._live=new Map,this._managed=new Set,this._pending=new Map,this._staged=new Map,this._keyedArrays=new Map,this._identifiers=new Map,this._set=new Map,this._visibilitySet=new Map,this._subscription=this.store.notifications.subscribe("resource",((e,t)=>{"added"===t?(this._visibilitySet.set(e,!0),this.identifierAdded(e)):"removed"===t?(this._visibilitySet.set(e,!1),this.identifierRemoved(e)):"state"===t&&this.identifierChanged(e)}))}_syncArray(e){const t=this._pending.get(e)
!t||this.isDestroying||this.isDestroyed||(function(e,t,i){const s=e[he],r=[],n=[]
t.forEach(((e,t)=>{if("add"===e){if(i.has(t))return
r.push(t),i.add(t)}else i.has(t)&&(n.push(t),i.delete(t))})),n.length&&(n.length===s.length?s.length=0:n.forEach((e=>{const t=s.indexOf(e);-1!==t&&(s.splice(t,1),i.delete(e))}))),r.length&&Re(s,r)}(e,t,this._set.get(e)),this._pending.delete(e))}liveArrayFor(e){let t=this._live.get(e)
const i=[],s=this._staged.get(e)
return s&&(s.forEach(((e,t)=>{"add"===e&&i.push(t)})),this._staged.delete(e)),t||(t=new ge({type:e,identifiers:i,store:this.store,allowMutation:!1,manager:this}),this._live.set(e,t),this._set.set(t,new Set(i))),t}createArray(e){const t={type:e.type,links:e.doc?.links||null,meta:e.doc?.meta||null,query:e.query||null,identifiers:e.identifiers||[],isLoaded:!!e.identifiers?.length,allowMutation:!1,store:this.store,manager:this},i=new be(t)
return this._managed.add(i),this._set.set(i,new Set(t.identifiers||[])),e.identifiers&&Se(this._identifiers,i,e.identifiers),i}dirtyArray(e,t){if(e===ve)return
const i=e[de]
i.shouldReset?t>0&&!i.t&&(0,l.Fe)(e[fe]):(i.shouldReset=!0,(0,l.Fe)(e[fe]))}_getPendingFor(e,t,i){if(this.isDestroying||this.isDestroyed)return
const s=this._live.get(e.type),r=this._pending,n=new Map
if(t){const t=this._identifiers.get(e)
t&&t.forEach((e=>{let t=r.get(e)
t||(t=new Map,r.set(e,t)),n.set(e,t)}))}if(s&&0===s[he].length&&i){const e=r.get(s)
if(!e||0===e.size)return n}if(s){let e=r.get(s)
e||(e=new Map,r.set(s,e)),n.set(s,e)}else{let t=this._staged.get(e.type)
t||(t=new Map,this._staged.set(e.type,t)),n.set(ve,t)}return n}populateManagedArray(e,t,i){this._pending.delete(e)
const s=e[he],r=s.slice()
s.length=0,Re(s,t),this._set.set(e,new Set(t)),ye(e),e.meta=i.meta||null,e.links=i.links||null,e.isLoaded=!0,function(e,t,i){for(let s=0;s<i.length;s++)Ae(e,t,i[s])}(this._identifiers,e,r),Se(this._identifiers,e,t)}identifierAdded(e){const t=this._getPendingFor(e,!1)
...
this._visibilitySet.get(e)!==t&&(t?this.identifierAdded(e):this.identifierRemoved(e))}clear(e=!0){this._live.forEach((t=>t.destroy(e))),this._managed.forEach((t=>t.destroy(e))),this._managed.clear(),this._identifiers.clear(),this._pending.clear(),this._set.forEach((e=>e.clear())),this._visibilitySet.clear()}destroy(){this.isDestroying=!0,this.clear(!1),this._live.clear(),this.isDestroyed=!0,this.store.notifications.unsubscribe(this._subscription)}}function Se(e,t,i){for(let s=0;s<i.length;s++){const r=i[s]
let n=e.get(r)
n||(n=new Set,e.set(r,n)),n.add(t)}}function Ae(e,t,i){const s=e.get(i)
s&&s.delete(t)}const Me=(0,n.L1)("Touching",Symbol("touching")),Ce=(0,n.L1)("RequestPromise",Symbol("promise")),Ee=[]
class Te{constructor(e){p(this,"_pending",new Map),p(this,"_done",new Map),p(this,"_subscriptions",new Map),p(this,"_toFlush",[]),p(this,"_store",void 0),this._store=e}_clearEntries(e){this._done.delete(e)}_enqueue(e,t){const i=t.data[0]
...
return n[Me]=[i.recordIdentifier],n[Ce]=e,this._pending.get(s).push(n),this._triggerSubscriptions(n),e.then((e=>{this._dequeue(s,n)
const i={state:"fulfilled",request:t,type:r,response:{data:e}}
return i[Me]=n[Me],this._addDone(i),this._triggerSubscriptions(i),e}),(e=>{this._dequeue(s,n)
...
i||(i=[],this._subscriptions.set(e,i)),i.push(t)}getPendingRequestsForRecord(e){return this._pending.get(e)||Ee}getLastRequestForRecord(e){const t=this._done.get(e)
return t?t[t.length-1]:null}}function qe(e){return Boolean(e&&"string"==typeof e)}function Oe(e,t,i){if("object"==typeof e&&null!==e){const t=e
return S(t)||"id"in t&&(t.id=y(t.id)),t}{const s=y(t)
if(!qe(s)){if(qe(i))return{lid:i}
throw new Error("Expected either id or lid to be a valid string")}return qe(i)?{type:e,id:s,lid:i}:{type:e,id:s}}}const De=(0,h.A)(i(471)),je=De.default?De.default:De
je!==class{constructor(e){}}&&(0,s.deprecate)("The Store class extending from EmberObject is deprecated.\nPlease remove usage of EmberObject APIs and mark your class as not requiring it.\n\nTo mark the class as no longer extending from EmberObject, in ember-cli-build.js\nset the following config:\n\n```js\nconst app = new EmberApp(defaults, {\n  emberData: {\n    deprecations: {\n      DEPRECATE_STORE_EXTENDS_EMBER_OBJECT: false\n    }\n  }\n});\n```\n",!1,{id:"ember-data:deprecate-store-extends-ember-object",until:"6.0",for:"ember-data",since:{available:"4.13",enabled:"5.4"}})
class Pe extends je{get schema(){return this._schema||(this._schema=this.createSchemaService()),this._schema}get isDestroying(){return this._isDestroying}set isDestroying(e){this._isDestroying=e}get isDestroyed(){return this._isDestroyed}set isDestroyed(e){this._isDestroyed=e}constructor(e){super(e),Object.assign(this,e),this.identifierCache=new P,this.notifications=new se(this),this.recordArrayManager=new ke({store:this}),this._requestCache=new Te(this),this._instanceCache=new Y(this),this._documentCache=new Map,this.isDestroying=!1,this.isDestroyed=!1}_run(e){const t=this._cbs={}
...
return this._join((()=>{const s=g(e),r={...t}
let n=null
if(null===r.id||void 0===r.id){const e=this.adapterFor?.(s,!0)
n=e&&e.generateIdForRecord?r.id=y(e.generateIdForRecord(this,s,r)):r.id=null}else n=r.id=y(r.id)
const o={type:s,id:n}
...
n&&("hasMany"===n.kind?i[s]=i[s].map((e=>Fe(e))):"belongsTo"===n.kind&&(i[s]=Fe(i[s])))}}}return i}(this,a,r),d=l.clientDidCreate(a,c)
...
t&&this._instanceCache.unloadRecord(t)}findRecord(e,t,i){Ne(e)?i=t:e=Oe(g(e),m(t))
...
return e||(e=this._instanceCache.cache=this.createCache(this._instanceCache._storeWrapper)),e}destroy(){this.isDestroyed||(this.isDestroying=!0,this._graph?.destroy(),this._graph=void 0,this.notifications.destroy(),this.recordArrayManager.destroy(),this.identifierCache.destroy(),this.unloadAll(),this.isDestroyed=!0)}static create(e){return new this(e)}}function Ne(e){return Boolean(null!==e&&"object"==typeof e&&("id"in e&&"type"in e&&e.id&&e.type||e.lid))}function Fe(e){return e?W(e):null}function Ie(e){return"string"==typeof e?e:e.href}Pe.prototype.getSchemaDefinitionService=function(){return(0,s.deprecate)("Use `store.schema` instead of `store.getSchemaDefinitionService()`",!1,{id:"ember-data:schema-service-updates",until:"6.0",for:"ember-data",since:{available:"4.13",enabled:"5.4"}}),this._schema},Pe.prototype.registerSchemaDefinitionService=function(e){(0,s.deprecate)("Use `store.createSchemaService` instead of `store.registerSchemaDefinitionService()`",!1,{id:"ember-data:schema-service-updates",until:"6.0",for:"ember-data",since:{available:"4.13",enabled:"5.4"}}),this._schema=e},Pe.prototype.registerSchema=function(e){(0,s.deprecate)("Use `store.createSchemaService` instead of `store.registerSchema()`",!1,{id:"ember-data:schema-service-updates",until:"6.0",for:"ember-data",since:{available:"4.13",enabled:"5.4"}}),this._schema=e}
var $e=new WeakMap,xe=new WeakSet
class ze{constructor(e,t){var i
u(this,i=xe),i.add(this),function(e,t){u(e,t),t.set(e,void 0)}(this,$e),function(e,t,i){e.set(f(e,t),i)}($e,this,e),this.identifier=t}fetch(e={}){return e.cacheOptions=e.cacheOptions||{},e.cacheOptions.key=this.identifier?.lid,f(xe,this,Le).call(this,this.links.related?"related":"self",e)}next(e={}){return f(xe,this,Le).call(this,"next",e)}prev(e={}){return f(xe,this,Le).call(this,"prev",e)}first(e={}){return f(xe,this,Le).call(this,"first",e)}last(e={}){return f(xe,this,Le).call(this,"last",e)}toJSON(){const e={}
return e.identifier=this.identifier,void 0!==this.data&&(e.data=this.data),void 0!==this.links&&(e.links=this.links),void 0!==this.errors&&(e.errors=this.errors),void 0!==this.meta&&(e.meta=this.meta),e}}async function Le(e,t){const i=this.links?.[e]
return i?(t.method=t.method||"GET",Object.assign(t,{url:Ie(i)}),(await(s=$e,s.get(f(s,this))).request(t)).content):null
var s}(0,l.sg)(ze.prototype,"data"),(0,l.sg)(ze.prototype,"links"),(0,l.sg)(ze.prototype,"errors"),(0,l.sg)(ze.prototype,"meta")
const Be=new Set(["createRecord","updateRecord","deleteRecord"])
function Ue(e){return Boolean(e.op&&Be.has(e.op))}function Ve(e,t){"links"in t&&(e.links=t.links),"meta"in t&&(e.meta=t.meta),"errors"in t&&(e.errors=t.errors)}function He(e){const t=function(e){return e instanceof AggregateError||"AggregateError"===e.name&&Array.isArray(e.errors)}(e),i=t?new AggregateError(structuredClone(e.errors),e.message):new Error(e.message)
return i.stack=e.stack,i.error=e.error,Object.assign(i,e),i}function We(e,t,i){if(e){const i=t.get(e)
if(i)return i.priority}return i}const Ke={request(e,t){if(!e.request.store||e.request.cacheOptions?.[r.ER])return t(e.request)
...
return t.op&&Be.has(t.op)||r?.reload||!i||!(!e.lifetimes||!s)&&e.lifetimes.isHardExpired(s,e)}(i,e.request,!!a,s)){if(o)return o.priority={blocking:!0},o.promise
...
if(e.setResponse(a.response),"error"in a){const e=l?Je(i,{shouldHydrate:l,identifier:s},a.content,!0):a.content,t=He(a)
throw t.content=e,t}return l?Ge(i,e.request,{shouldHydrate:l,identifier:s},a.content,!0):a.content}}
function Ge(e,t,i,s,r){const{identifier:n}=i
if(!s)return s
if(Array.isArray(s.data)){const{recordArrayManager:o}=e
if(!n){if(!i.shouldHydrate)return s
const r=o.createArray({type:t.url,identifiers:s.data,doc:s,query:t}),n=new ze(e,null)
...
let o
return n&&(o=e._documentCache.get(n)),o?r||(o.data=t,Ve(o,s)):(o=new ze(e,n),o.data=t,Ve(o,s),n&&e._documentCache.set(n,o)),i.shouldHydrate?o:s}}function Je(e,t,i,s){const{identifier:r}=t
if(!function(e){return"errors"in e}(i)||!r&&!t.shouldHydrate)return i
let n
return r&&(n=e._documentCache.get(r)),n?s||(n.data=void 0,Ve(n,i)):(n=new ze(e,r),Ve(n,i),r&&e._documentCache.set(r,n)),t.shouldHydrate?n:i}function Ye(e,t,i,s){const{store:n}=t.request,o={shouldHydrate:t.request[r._q]||!1,identifier:i,priority:s}
let a=!1
if(Ue(t.request)){a=!0
...
if(Ue(t)){const i=t.data?.record||t.records?.[0]
i?r=e.cache.didCommit(i,s):function(e){return!Ue(e.request)||("createRecord"===e.request.op&&201===e.response?.status?!!e.content&&Object.keys(e.content).length>0:204!==e.response?.status)}(s)&&(r=e.cache.put(s))}else r=e.cache.put(s)
return Ge(e,t,i,r,!1)}(e,r,i,s)})),e._enableAsyncFlush=null,e.lifetimes?.didRequest&&e.lifetimes.didRequest(t.request,s.response,i.identifier,e),We(i.identifier,e.requestManager._deduped,i.priority).blocking)return n
...
if(!Ue(t.request))return r=e.cache.put(s),Je(e,i,r,!1)
...
e.cache.commitWasRejected(r,i)}}(e,t,i,s)})),e._enableAsyncFlush=null,i.identifier&&e.lifetimes?.didRequest&&e.lifetimes.didRequest(t.request,s.response,i.identifier,e),Ue(t.request))throw s
if(We(i.identifier,e.requestManager._deduped,i.priority).blocking){const e=He(s)
throw e.content=r,e}e.notifications._flush()}(n,t,o,e)))
if(!a)return l
const c=t.request.data?.record||t.request.records?.[0]
return n._requestCache._enqueue(l,{data:[{op:"saveRecord",recordIdentifier:c,options:void 0}]})}},81:(e,t,i)=>{function s(e,t,i){return(t="symbol"==typeof(s=function(e){if("object"!=typeof e||!e)return e
var t=e[Symbol.toPrimitive]
if(void 0!==t){var i=t.call(e,"string")
if("object"!=typeof i)return i
...
return Object.keys(s).forEach((function(e){n[e]=s[e]})),n.enumerable=!!n.enumerable,n.configurable=!!n.configurable,("value"in n||n.initializer)&&(n.writable=!0),n=i.slice().reverse().reduce((function(i,s){return s(e,t,i)||i}),n),r&&void 0!==n.initializer&&(n.value=n.initializer?n.initializer.call(r):void 0,n.initializer=void 0),void 0===n.initializer&&(Object.defineProperty(e,t,n),n=null),n}i.d(t,{_:()=>n,a:()=>r,b:()=>s})},82:(e,t,i)=>{i.d(t,{Ay:()=>a,ud:()=>r.b})
var s=i(375),r=i(464)
...
i=[],function(e,t){if(t.has(e))throw new TypeError("Cannot initialize the same private elements twice on an object")}(this,t=o),t.set(this,i),Object.assign(this,e),this._pending=new Map,this._deduped=new Map}useCache(e){return e[r.I]=!0,n(o,this).unshift(e),this}use(e){return n(o,this).push(...e),this}request(e){const t=n(o,this),i=e.controller||new AbortController
e.controller&&delete e.controller
const a=(0,s.dN)("REQ_ID")??0;(0,s.ml)("REQ_ID",a+1)
const l={controller:i,response:null,stream:null,hasRequestedStream:!1,id:a,identifier:null},c=(0,r.e)(t,e,0,l),d=(0,r.g)(a),h=(0,r.u)(c.then((e=>((0,r.s)(h,{isError:!1,result:e}),(0,r.c)(a),e)),(e=>{throw(0,r.s)(h,{isError:!0,result:e}),(0,r.c)(a),e})),c)
return d&&(0,r.s)(h,d),h}static create(e){return new this(e)}}},113:(e,t,i)=>{i.r(t),i.d(t,{BooleanTransform:()=>l,DateTransform:()=>c,NumberTransform:()=>h,StringTransform:()=>u,default:()=>a})
...
if(i)return i.get(t)}},151:(e,t,i)=>{i.r(t),i.d(t,{graphFor:()=>V,isBelongsTo:()=>d,peekGraph:()=>U})
...
t(s)}e.additions?.forEach(t)}else e.localMembers.forEach(t),e.remoteMembers.forEach((i=>{e.localMembers.has(i)||t(i)}))}function p(e,t,i,s){if(d(t))t.remoteState===i&&(t.remoteState=null),t.localState===i&&(t.localState=null,y(e,t.identifier,t.definition.key))
else if(u(t)){t.remoteMembers.delete(i),t.additions?.delete(i)
const s=t.removals?.delete(i),r=t.remoteState.indexOf(i)
if(-1!==r&&t.remoteState.splice(r,1),!s){const s=t.localState?.indexOf(i);-1!==s&&void 0!==s&&(t.localState.splice(s,1),y(e,t.identifier,t.definition.key))}}else t.remoteMembers.delete(i),t.localMembers.delete(i)}function y(e,t,i){t!==e._removing&&e.store.notifyChange(t,"relationships",i)}function m(e){return"belongsTo"===e.kind||"hasMany"===e.kind}const g=null,_=Date.now()
...
const i={},s=e.options
return i.kind=e.kind,i.key=e.name,i.type=e.type,i.isAsync=s.async,i.isImplicit=!1,i.isCollection="hasMany"===e.kind,i.isPolymorphic=s&&!!s.polymorphic,i.isLinksMode=s.linksMode??!1,i.inverseKey=s&&s.inverse||"",i.inverseType="",i.inverseIsAsync=g,i.inverseIsImplicit=s&&null===s.inverse||g,i.inverseIsCollection=g,i.inverseIsLinksMode=g,i.resetOnRemoteUpdate=!!m(e)&&!e.options?.linksMode&&!1!==e.options?.resetOnRemoteUpdate,i}function R(e,t,i){i?function(e,t,i){const r=t.value,n=e.get(t.record,t.field)
i&&e._addToTransaction(n),n.state.hasReceivedData=!0
const{definition:o}=n,{type:a}=n.definition,l=C(r,n,(s=>{a!==s.type&&e.registerPolymorphicType(a,s.type),n.additions?.has(s)?n.additions.delete(s):n.isDirty=!0,k(e,s,o.inverseKey,t.record,i)}),(s=>{n.removals?.has(s)?n.removals.delete(s):n.isDirty=!0,S(e,s,o.inverseKey,t.record,i)}))
if(n.remoteMembers=l.finalSet,n.remoteState=l.finalState,l.changed&&(n.isDirty=!0),n._diff=l,"hasMany"===n.definition.kind&&!1!==n.definition.resetOnRemoteUpdate){const r={removals:[],additions:[],triggered:!1}
n.removals&&(n.isDirty=!0,n.removals.forEach((s=>{r.triggered=!0,r.removals.push(s),k(e,s,o.inverseKey,t.record,i)})),n.removals=null),n.additions&&(n.additions.forEach((s=>{c(s)||(r.triggered=!0,r.additions.push(s),n.isDirty=!0,n.additions.delete(s),S(e,s,o.inverseKey,t.record,i))})),0===n.additions.size&&(n.additions=null)),r.triggered&&(0,s.deprecate)(`EmberData is changing the default semantics of updates to the remote state of relationships.\n\nThe following local state was cleared from the <${n.identifier.type}>.${n.definition.key} hasMany relationship but will not be once this deprecation is resolved by opting into the new behavior:\n\n\tAdded: [${r.additions.map((e=>e.lid)).join(", ")}]\n\tRemoved: [${r.removals.map((e=>e.lid)).join(", ")}]`,!1,{id:"ember-data:deprecate-relationship-remote-update-clearing-local-state",for:"ember-data",since:{enabled:"5.3",available:"4.13"},until:"6.0",url:"https://deprecations.emberjs.com/v5.x#ember-data-deprecate-relationship-remote-update-clearing-local-state"})}n.isDirty&&A(e,n)}(e,t,i):function(e,t,i){const s=t.value,r=e.get(t.record,t.field),n=0===r.remoteState.length&&null===r.localState&&!1===r.state.hasReceivedData
r.state.hasReceivedData=!0
const{additions:o,removals:a}=r,{inverseKey:l,type:c}=r.definition,{record:d}=t,h=r.isDirty
r.isDirty=!1
const u=s=>{const n=a?.has(s)
!n&&o?.has(s)||(c!==s.type&&e.registerPolymorphicType(c,s.type),r.isDirty=!0,k(e,s,l,t.record,i),n&&a.delete(s))},f=t=>{const s=o?.has(t)
!s&&a?.has(t)||(r.isDirty=!0,S(e,t,l,d,i),s&&o.delete(t))},p=C(s,r,u,f)
r.isDirty||p.changed,o&&o.size>0&&o.forEach((e=>{p.add.has(e)||f(e)})),a&&a.size>0&&a.forEach((e=>{p.del.has(e)||u(e)})),r.additions=p.add,r.removals=p.del,r.localState=p.finalState,r.isDirty=h,(n||!h)&&y(e,t.record,t.field)}(e,t,i)}function k(e,t,i,s,r){const n=e.get(t,i),{type:o}=n.definition
o!==s.type&&e.registerPolymorphicType(o,s.type),d(n)?(n.state.hasReceivedData=!0,n.state.isEmpty=!1,r&&(e._addToTransaction(n),null!==n.remoteState&&S(e,n.remoteState,n.definition.inverseKey,t,r),n.remoteState=s),n.localState!==s&&(!r&&n.localState&&S(e,n.localState,n.definition.inverseKey,t,r),n.localState=s,y(e,t,i))):u(n)?r?n.remoteMembers.has(s)||(e._addToTransaction(n),n.remoteState.push(s),n.remoteMembers.add(s),n.additions?.has(s)?n.additions.delete(s):(n.isDirty=!0,n.state.hasReceivedData=!0,A(e,n))):E(e,0,n,s,null)&&y(e,t,i):r?n.remoteMembers.has(s)||(n.remoteMembers.add(s),n.localMembers.add(s)):n.localMembers.has(s)||n.localMembers.add(s)}function S(e,t,i,s,r){const n=e.get(t,i)
d(n)?(n.state.isEmpty=!0,r&&(e._addToTransaction(n),n.remoteState=null),n.localState===s&&(n.localState=null,y(e,t,i))):u(n)?r?(e._addToTransaction(n),function(e,t){const{remoteMembers:i,additions:s,removals:r,remoteState:n}=e
if(!i.has(t))return!1
i.delete(t)
let o=n.indexOf(t)
return n.splice(o,1),r?.has(t)?(r.delete(t),!1):(e.localState&&(o=e.localState.indexOf(t),e.localState.splice(o,1)),!0)}(n,s)&&y(e,t,i)):T(n,s)&&y(e,t,i):r?(n.remoteMembers.delete(s),n.localMembers.delete(s)):s&&n.localMembers.has(s)&&n.localMembers.delete(s)}function A(e,t){e._scheduleLocalSync(t)}function M(e,t,i=!1){const r=e.get(t.record,t.field)
...
if(t&&c(t)&&!i)return
t!==i&&t===l?(r.localState=i,y(e,r.identifier,r.definition.key)):t!==i&&t!==l&&!1!==r.definition.resetOnRemoteUpdate&&(r.localState=i,(0,s.deprecate)(`EmberData is changing the default semantics of updates to the remote state of relationships.\n\nThe following local state was cleared from the <${r.identifier.type}>.${r.definition.key} belongsTo relationship but will not be once this deprecation is resolved:\n\n\t${t?"Added: "+t.lid+"\n\t":""}${l?"Removed: "+l.lid:""}`,!1,{id:"ember-data:deprecate-relationship-remote-update-clearing-local-state",for:"ember-data",since:{enabled:"5.3",available:"4.13"},until:"6.0",url:"https://deprecations.emberjs.com/v5.x#ember-data-deprecate-relationship-remote-update-clearing-local-state"}),y(e,r.identifier,r.definition.key))}else y(e,r.identifier,r.definition.key)
else if(o.hasReceivedData=!0,i){const{localState:o}=r
if(o&&c(o)&&!l)return
l&&o===l?function(e,t,i,s,r){const n=e.get(t,i)
u(n)&&r&&n.remoteMembers.has(s)&&y(e,t,i)}(e,l,n.inverseKey,t.record,i):o!==t.value&&!1!==r.definition.resetOnRemoteUpdate&&(r.localState=l,(0,s.deprecate)(`EmberData is changing the default semantics of updates to the remote state of relationships.\n\nThe following local state was cleared from the <${r.identifier.type}>.${r.definition.key} belongsTo relationship but will not be once this deprecation is resolved:\n\n\t${o?"Added: "+o.lid+"\n\t":""}${l?"Removed: "+l.lid:""}`,!1,{id:"ember-data:deprecate-relationship-remote-update-clearing-local-state",for:"ember-data",since:{enabled:"5.3",available:"4.13"},until:"6.0",url:"https://deprecations.emberjs.com/v5.x#ember-data-deprecate-relationship-remote-update-clearing-local-state"}),y(e,r.identifier,r.definition.key))}}function C(e,t,i,s){const r=new Set(e),{remoteState:n,remoteMembers:o}=t
if(e.length!==r.size){const{diff:t,duplicates:a}=function(e,t,i,s,r,n){const o=e.length,a=i.length,l=Math.max(o,a)
let c=t.size!==s.size
const d=new Set,h=new Set,u=new Map,f=new Set,p=[]
for(let y=0,m=0;y<l;y++){let l,g=!1
if(y<o)if(l=e[y],f.has(l)){let e=u.get(l)
void 0===e&&(e=[],u.set(l,e)),e.push(y)}else p[m]=l,f.add(l),g=!0,s.has(l)||(c=!0,d.add(l),r(l))
if(y<a){const e=i[y]
l!==i[m]&&(c=!0),t.has(e)||(c=!0,h.add(e),n(e))}else g&&m<a&&l!==i[m]&&(c=!0)
g&&m++}return{diff:{add:d,del:h,finalState:p,finalSet:f,changed:c},duplicates:u}}(e,r,n,o,i,s)
return t}return function(e,t,i,s,r,n){const o=e.length,a=i.length,l=Math.max(o,a),c=o===a
let d=t.size!==s.size
const h=new Set,u=new Set
for(let f=0;f<l;f++){let l
if(f<o&&(l=e[f],s.has(l)||(d=!0,h.add(l),r(l))),f<a){const e=i[f]
c&&l!==e&&(d=!0),t.has(e)||(d=!0,u.add(e),n(e))}}return{add:h,del:u,finalState:e,finalSet:t,changed:d}}(e,r,n,o,i,s)}function E(e,t,i,s,r){const{remoteMembers:n,removals:o}=i
let a=i.additions
...
e.localState.splice(i,1)}return!0}function q(e,t,i,s){d(s)?M(e,{op:"replaceRelatedRecord",record:t,field:i,value:s.remoteState},!1):R(e,{op:"replaceRelatedRecords",record:t,field:i,value:s.remoteState.slice()},!1)}function O(e){const t={}
...
t.splice(i,1)})),e.additions?.forEach((e=>{t.push(e)})),e.localState=t,e.isDirty=!1,t}(e)),e.links&&(t.links=e.links),e.meta&&(t.meta=e.meta),t}function D(e,t,i,s,r,n){E(e,0,t,s,r??null)&&k(e,s,t.definition.inverseKey,i,n)}function j(e,t,i,s,r){T(t,s)&&S(e,s,t.definition.inverseKey,i,r)}function P(e){switch(typeof e){case"object":return e
...
if(r)return l(s,c,i,r),r.rhs_modelNames.push(c),r}}return s[c][i]=null,null}const u=w(h)
let f,p
const y=u.type
if(null===u.inverseKey?f=null:(p=function(e,t,i){const s=e.schema.fields(t).get(i)
return s?s.options.inverse:null}(o(r),t,i),f=!p&&u.isPolymorphic&&u.inverseKey?{kind:"belongsTo",key:u.inverseKey,type:c,isAsync:!1,isImplicit:!1,isCollection:!1,isPolymorphic:!1}:p?w(r.schema.fields({type:y}).get(p)):null),!f){p=b(c,i),f={kind:"implicit",key:p,type:c,isAsync:!1,isImplicit:!0,isCollection:!0,isPolymorphic:!1},v(u,f),v(f,u)
...
const g=[c]
c!==m&&g.push(m)
const _=m===y,R={lhs_key:`${m}:${i}`,lhs_modelNames:g,lhs_baseModelName:m,lhs_relationshipName:i,lhs_definition:u,lhs_isPolymorphic:u.isPolymorphic,rhs_key:`${y}:${p}`,rhs_modelNames:[y],rhs_baseModelName:y,rhs_relationshipName:p,rhs_definition:f,rhs_isPolymorphic:f.isPolymorphic,hasInverse:!0,isSelfReferential:_,isReflexive:_&&i===p}
return l(s,m,i,R),l(s,c,i,R),l(s,y,p,R),R}(this,e,t)
...
s&&(function(e,t,i){if(h(t))return void(e.isReleasable(t.identifier)&&z(e,t))
...
!t.definition.isAsync||i&&c(i)?(t.localState===i&&null!==i&&(t.localState=null),t.remoteState===i&&null!==i&&(t.remoteState=null,t.state.hasReceivedData=!0,t.state.isEmpty=!0,t.localState&&!c(t.localState)&&(t.localState=null))):t.state.hasDematerializedInverse=!0,s||y(e,t.identifier,t.definition.key)}else!t.definition.isAsync||i&&c(i)?p(e,t,i):t.state.hasDematerializedInverse=!0,s||y(e,t.identifier,t.definition.key)}(e,n,s,r)}(e,t,r,s,i))),t.definition.inverseIsImplicit||t.definition.inverseIsAsync||(t.state.isStale=!0,x(t),t.definition.isAsync||i||y(e,t.identifier,t.definition.key))}(this,s,t),h(s)&&(i[e]=void 0))}))}_isDirty(e,t){const i=this.identifiers.get(e)
if(!i)return!1
const s=i[t]
if(!s)return!1
...
return e||t||L(s)}return!1}getChanged(e){const t=this.identifiers.get(e),i=new Map
if(!t)return i
...
else if(u(n)){const t=null!==n.additions&&n.additions.size>0,s=null!==n.removals&&n.removals.size>0,r=L(n);(t||s||r)&&i.set(e,{kind:"collection",additions:new Set(n.additions),removals:new Set(n.removals),remoteState:n.remoteState,localState:O(n).data||[],reordered:r})}}return i}hasChanged(e){const t=this.identifiers.get(e)
if(!t)return!1
const i=Object.keys(t)
...
t.remoteState.splice(e,1,i.value),t.isDirty=!0}t.additions?.has(i.record)&&(t.additions.delete(i.record),t.additions.add(i.value),t.isDirty=!0),t.removals?.has(i.record)&&(t.removals.delete(i.record),t.removals.add(i.value),t.isDirty=!0),t.isDirty&&y(e,t.identifier,t.definition.key)}(e,t,i):function(e,t,i){t.remoteMembers.has(i.record)&&(t.remoteMembers.delete(i.record),t.remoteMembers.add(i.value)),t.localMembers.has(i.record)&&(t.localMembers.delete(i.record),t.localMembers.add(i.value))}(0,t,i)}(e,r,t)}))}(e,t,r)}))}(this,e,t)
...
t&&(i[e]=void 0,z(this,t))})),this.identifiers.delete(t))
...
if(Array.isArray(r))for(let a=0;a<r.length;a++)D(e,o,s,r[a],void 0!==n?n+a:n,i)
else D(e,o,s,r,n,i)
...
if(Array.isArray(r))for(let o=0;o<r.length;o++)j(e,n,s,r[o],i)
else j(e,n,s,r,i)
...
s&&$(this,s),r&&$(this,r),this._transaction=null}_addToTransaction(e){e.transactionRef=this._transaction}_flushLocalQueue(){if(!this._willSyncLocal)return
if(this.silenceNotifications)return this.silenceNotifications=!1,void(this._updatedRelationships=new Set)
this._willSyncLocal=!1
const e=this._updatedRelationships
this._updatedRelationships=new Set,e.forEach((e=>y(this,e.identifier,e.definition.key)))}destroy(){F.delete(this.store),this.identifiers.clear(),this.store=null,this.isDestroyed=!0}}function $(e,t){t.forEach((t=>{t.forEach((t=>{!function(e,t){for(let i=0;i<t.length;i++)e.update(t[i],!0)}(e,t)}))}))}function x(e){d(e)?(e.localState=null,e.remoteState=null,e.state.hasReceivedData=!1,e.state.isEmpty=!0):(e.remoteMembers.clear(),e.remoteState=[],e.additions=null,e.removals=null,e.localState=null)}function z(e,t){const{identifier:i}=t,{inverseKey:s}=t.definition
f(t,(t=>{e.has(t,s)&&p(e,e.get(t,s),i)})),d(t)?(t.definition.isAsync||x(t),t.localState=null):u(t)?t.definition.isAsync||(x(t),y(e,t.identifier,t.definition.key)):(t.remoteMembers.clear(),t.localMembers.clear())}function L(e){if(e.isDirty)return!1
...
if(s&&s.has(a)){o++,n--
continue}return!0}o++}return!1}function B(e){return void 0!==e._instanceCache?e._instanceCache._storeWrapper:e}function U(e){return F.get(B(e))}function V(e){const t=B(e)
let i=F.get(t)
return i||(i=new I(t),F.set(t,i),o(t)._graph=i),i}},193:(e,t,i)=>{function s(e){return e?.__esModule?e:{default:e,...e}}i.d(t,{A:()=>s})},234:(e,t,i)=>{i.r(t),i.d(t,{default:()=>ft})
var s=i(151)
const r={iterator:()=>({next:()=>({done:!0,value:void 0})})}
class n{constructor(e){this.version="2",this._capabilities=e,this.__cache=new Map,this.__graph=(0,s.graphFor)(e),this.__destroyedCache=new Map,this.__documents=new Map}put(e){if(b(e))return this._putDocument(e,void 0,void 0)
...
if(i)for(s=0,r=i.length;s<r;s++)i[s]=g(this,n,i[s])
if(Array.isArray(t.data)){r=t.data.length
const o=[]
for(s=0;s<r;s++)o.push(g(this,n,t.data[s]))
return this._putDocument(e,o,i)}if(null===t.data)return this._putDocument(e,null,i)
const o=g(this,n,t.data)
return this._putDocument(e,o,i)}_putDocument(e,t,i){const s=b(e)?function(e){const t={}
...
this.__documents.set(n.lid,e),this._capabilities.notifyChange(n,t?"updated":"added")}return s}patch(e){if("mergeIdentifiers"===e.op){const t=this.__cache.get(e.record)
...
return!u(e)&&s.getPendingRequestsForRecord(i).some((e=>"query"===e.type))}(r,this._capabilities,e)||!u(r),l=!function(e){if(!e)return!0
const t=e.isNew,i=e.isDeleted,s=h(e)
return(!t||i)&&s}(r)&&!a
return o.isNew&&(o.isNew=!1,this._capabilities.notifyChange(e,"identity"),this._capabilities.notifyChange(e,"state")),i&&(s=n?d(o,t.attributes):Object.keys(t.attributes||{})),o.remoteAttrs=Object.assign(o.remoteAttrs||Object.create(null),t.attributes),o.localAttrs&&m(o)&&this._capabilities.notifyChange(e,"state"),l||this._capabilities.notifyChange(e,"added"),t.id&&(o.id=t.id),t.relationships&&f(this.__graph,this._capabilities,e,t),s&&s.length&&c(this._capabilities,e,s),s}fork(){throw new Error("Not Implemented")}merge(e){throw new Error("Not Implemented")}diff(){throw new Error("Not Implemented")}dump(){throw new Error("Not Implemented")}hydrate(e){throw new Error("Not Implemented")}clientDidCreate(e,t){this._createCache(e).isNew=!0
const i={}
...
let h
l.isDeleted&&(this.__graph.push({op:"deleteRecord",record:a,isNew:!1}),l.isDeletionCommitted=!0,this._capabilities.notifyChange(a,"removed")),l.isNew=!1,r&&(r.id&&!l.id&&(l.id=r.id),a===e&&a.id!==o&&this._capabilities.notifyChange(a,"identity"),r.relationships&&f(this.__graph,this._capabilities,a,r),h=r.attributes)
const u=d(l,h)
...
for(let s=0;s<e.length;s++)void 0===t[e[s]]&&(t[e[s]]=i.inflightAttrs[e[s]])}i.inflightAttrs=null}t&&(i.errors=t),this._capabilities.notifyChange(e,"errors")}unloadRecord(e){const t=this._capabilities
...
t.notifyChange(e,"removed"),r=!0,t.disconnectRecord(e)}this.__cache.delete(e),this.__destroyedCache.set(e,n),1===this.__destroyedCache.size&&setTimeout((()=>{this.__destroyedCache.clear()}),100),!r&&i&&t.notifyChange(e,"removed")}getAttr(e,t){const i=!Array.isArray(t)||1===t.length
...
return(s=t)&&a(s.options)&&(r.defaultAttrs=r.defaultAttrs||Object.create(null),r.defaultAttrs[i]=n),n}}var s
const r=t,n=this.__peek(e,!0),o=r[0]
let c=n.localAttrs&&o in n.localAttrs?n.localAttrs[o]:void 0
if(void 0===c&&(c=n.inflightAttrs&&o in n.inflightAttrs?n.inflightAttrs[o]:void 0),void 0===c&&(c=n.remoteAttrs&&o in n.remoteAttrs?n.remoteAttrs[o]:void 0),void 0!==c){for(let e=1;e<r.length;e++)if(c=c[r[e]],void 0===c)return
return c}}setAttr(e,t,i){const s=!Array.isArray(t)||1===t.length
...
return!i&&t&&(i=this.__destroyedCache.get(e)),i}__peek(e,t){return this.__safePeek(e,t)}}function o(e){return(0,s.isBelongsTo)(e)?e.remoteState?[e.remoteState]:[]:e.remoteState}function a(e){return!!e&&"function"==typeof e.defaultValue}function l(e,t,i){const s=e?.options
if(e&&(s||e.type)&&("attribute"===e.kind||"field"===e.kind)){if(a(s))return s.defaultValue()
if(s&&"defaultValue"in s)return s.defaultValue
if("attribute"!==e.kind&&e.type){const r=i.schema.transformation(e)
if(r?.defaultValue)return r.defaultValue(s||null,t)}}}function c(e,t,i){if(i)for(let s=0;s<i.length;s++)e.notifyChange(t,"attributes",i[s])
else e.notifyChange(t,"attributes")}function d(e,t){const i=[]
if(t){const s=Object.keys(t),r=s.length,n=e.localAttrs,o=Object.assign(Object.create(null),e.remoteAttrs,e.inflightAttrs)
for(let e=0;e<r;e++){const r=s[e],a=t[r]
n&&void 0!==n[r]||o[r]!==a&&i.push(r)}}return i}function h(e){return!e||null===e.remoteAttrs&&null===e.inflightAttrs&&null===e.localAttrs}function u(e,t=!1){if(!e)return!1
const i=e.isNew,s=h(e)
return i?!e.isDeleted:!(t&&e.isDeletionCommitted||s)}function f(e,t,i,s){const r=t.schema.fields(i)
for(const[n,o]of r){if(!y(o))continue
const t=s.relationships[n]
t&&e.push({op:"updateRelationship",record:i,field:n,value:t})}}const p=new Set(["hasMany","belongsTo","resource","collection"])
function y(e){return p.has(e.kind)}function m(e){const{localAttrs:t,remoteAttrs:i,inflightAttrs:s,defaultAttrs:r,changes:n}=e
if(!t)return e.changes=null,!1
let o=!1
const a=Object.keys(t)
for(let l=0,c=a.length;l<c;l++){const e=a[l];(s&&e in s?s[e]:i&&e in i?i[e]:void 0)===t[e]&&(o=!0,delete t[e],delete n[e]),r&&e in r&&delete r[e]}return o}function g(e,t,i){let s=t.peekRecordIdentifier(i)
return s=s?t.updateRecordIdentifier(s,i):t.getOrCreateRecordIdentifier(i),e.upsert(s,i,e._capabilities.hasRecord(s)),s}function _(e,t){const i=(0,s.peekGraph)(e),n=i?.identifiers.get(t)
if(!n)return r
const a=[]
Object.keys(n).forEach((e=>{const t=n[e]
t&&!t.definition.isImplicit&&a.push(t)}))
let l=0,c=0,d=0
return{iterator:()=>({next:()=>{const e=(()=>{for(;l<a.length;){for(;c<2;){const t=0===c?(e=a[l],(0,s.isBelongsTo)(e)?e.localState?[e.localState]:[]:e.additions?[...e.additions]:[]):o(a[l])
...
const i=(0,k.di)(e),{_adapterCache:s}=this
let r=s[i]
if(r)return r
const n=(0,w.getOwner)(this)
return r=n.lookup(`adapter:${i}`),void 0!==r?(s[i]=r,r):(r=s.application||n.lookup("adapter:application"),void 0!==r?(s[i]=r,s.application=r,r):void 0)}function O(e){this._serializerCache=this._serializerCache||Object.create(null)
const t=(0,k.di)(e),{_serializerCache:i}=this
let s=i[t]
if(s)return s
const r=(0,w.getOwner)(this)
return s=r.lookup(`serializer:${t}`),void 0!==s?(i[t]=s,s):(s=i.application||r.lookup("serializer:application"),void 0!==s?(i[t]=s,i.application=s,s):null)}function D(e,t){const i=(0,k.di)(e),s=this.serializerFor(i),r=this.modelFor(i)
return s.normalize(r,t)}function j(e,t){const i=t||e,s=t?(0,k.di)(e):"application"
this.serializerFor(s).pushPayload(this,i)}function P(e,t){return this._fetchManager||(this._fetchManager=new S.F(this)),this._fetchManager.createSnapshot((0,R.o)(e)).serialize(t)}function N(){for(const e in this._adapterCache){const t=this._adapterCache[e]
"function"==typeof t.destroy&&t.destroy()}for(const e in this._serializerCache){const t=this._serializerCache[e]
"function"==typeof t.destroy&&t.destroy()}}var F,I,$,x,z,L=i(603),B=i(241),U=i(471),V=i.n(U),H=i(738),W=i(146),K=i(788),G=i(389),J=i(410),Y=i.n(J),Z=i(991),X=i(491),Q=i(375),ee=i(648),te=i(280),ie=i.n(te),se=i(104),re=i.n(se),ne=i(666),oe=i(193)
...
return(0,L.deprecate)(`The resource type '${e}' is not normalized. Update your application code to use '${t}' instead of '${e}'.`,t===e,{id:"ember-data:deprecate-non-strict-types",until:"6.0",for:"ember-data",since:{available:"4.13",enabled:"5.3"}}),t}}class de extends k.oz{constructor(e){super(e),this.isLoaded=e.isLoaded||!1,this.isAsync=e.isAsync||!1,this.isPolymorphic=e.isPolymorphic||!1,this.identifier=e.identifier,this.key=e.key}[k.XK](e,t,i,s,r){switch(i){case"length 0":return Reflect.set(e,"length",0),me(this,[],r),!0
case"replace cell":{const[t,i,n]=s
return e[t]=n,function(e,t,i){ge(e,{op:"replaceRelatedRecord",record:e.identifier,field:e.key,...t},i)}(this,{value:n,prior:i,index:t},r),!0}case"push":{const n=he(s)
fe(this,e,(e=>e.push(...n)),"Cannot push duplicates to a hasMany's state.")
{const n=new Set(e),o=new Set
s.forEach((e=>{const t=(0,k.o)(e)
n.has(t)||(n.add(t),o.add(e))}))
const a=Array.from(o),l=Reflect.apply(e[i],t,a)
return a.length&&pe(this,{value:he(a)},r),l}}case"pop":{const n=Reflect.apply(e[i],t,s)
return n&&ye(this,{value:(0,k.o)(n)},r),n}case"unshift":{const n=he(s)
fe(this,e,(e=>e.unshift(...n)),"Cannot unshift duplicates to a hasMany's state.")
{const n=new Set(e),o=new Set
s.forEach((e=>{const t=(0,k.o)(e)
n.has(t)||(n.add(t),o.add(e))}))
const a=Array.from(o),l=Reflect.apply(e[i],t,a)
return a.length&&pe(this,{value:he(a),index:0},r),l}}case"shift":{const n=Reflect.apply(e[i],t,s)
return n&&ye(this,{value:(0,k.o)(n),index:0},r),n}case"sort":{const n=Reflect.apply(e[i],t,s)
return function(e,t,i){ge(e,{op:"sortRelatedRecords",record:e.identifier,field:e.key,value:t},i)}(this,n.map(k.o),r),n}case"splice":{const[n,o,...a]=s
if(0===n&&o===this[k.u2].length){const s=he(a)
fe(this,e,(e=>e.splice(n,o,...s)),"Cannot replace a hasMany's state with a new state that contains duplicates.")
{const s=new Set(a),l=Array.from(s),c=[n,o].concat(l),d=Reflect.apply(e[i],t,c)
return me(this,he(l),r),d}}const l=he(a)
fe(this,e,(e=>e.splice(n,o,...l)),"Cannot splice a hasMany's state with a new state that contains duplicates.")
{const s=e.slice()
s.splice(n,o)
const l=new Set(s),c=[]
...
return o>0&&ye(this,{value:h.map(k.o),index:n},r),c.length>0&&pe(this,{value:he(c),index:n},r),h}}}}notify(){this[k.To].shouldReset=!0,(0,k.J4)(this)}reload(e){return this._manager.reloadHasMany(this.key,e)}createRecord(e){const{store:t}=this,i=t.createRecord(this.modelName,e)
return this.push(i),i}destroy(){super.destroy(!1)}}function he(e){return e.map(ue)}function ue(e){return(0,k.o)(e)}function fe(e,t,i,s){const r=t.slice()
if(i(r),r.length!==new Set(r).size){const t=r.filter(((e,t)=>r.indexOf(e)!==t));(0,L.deprecate)(`${s} This behavior is deprecated. Found duplicates for the following records within the new state provided to \`<${e.identifier.type}:${e.identifier.id||e.identifier.lid}>.${e.key}\`\n\t- ${Array.from(new Set(t)).map((e=>(0,k.xm)(e)?e.lid:(0,k.o)(e).lid)).sort(((e,t)=>e.localeCompare(t))).join("\n\t- ")}`,!1,{id:"ember-data:deprecate-many-array-duplicates",for:"ember-data",until:"6.0",since:{enabled:"5.3",available:"4.13"}})}}function pe(e,t,i){ge(e,{op:"addToRelatedRecords",record:e.identifier,field:e.key,...t},i)}function ye(e,t,i){ge(e,{op:"removeFromRelatedRecords",record:e.identifier,field:e.key,...t},i)}function me(e,t,i){ge(e,{op:"replaceRelatedRecords",record:e.identifier,field:e.key,value:t},i)}function ge(e,t,i){e._manager.mutate(t),(0,W.RH)(i)}de.prototype.isAsync=!1,de.prototype.isPolymorphic=!1,de.prototype.identifier=null,de.prototype.cache=null,de.prototype._inverseIsAsync=!1,de.prototype.key="",de.prototype.DEPRECATED_CLASS_NAME="ManyArray"
const _e=re().extend(ie()),be=new WeakMap
function ve(e,t,i,s){let r={configurable:!0,enumerable:!0,writable:!0,initializer:null}
s&&(r.initializer=s)
for(let n of i)r=n(e,t,r)||r
void 0===r.initializer?Object.defineProperty(e,t,r):function(e,t,i){let s=be.get(e)
s||(s=new Map,be.set(e,s)),s.set(t,i)}(e,t,r)}function we(e,t,i){let s={...Object.getOwnPropertyDescriptor(e,t)}
for(let r of i)s=r(e,t,s)||s
void 0!==s.initializer&&(s.value=s.initializer?s.initializer.call(e):void 0,s.initializer=void 0),Object.defineProperty(e,t,s)}function Re(e,t){let i=function(e,t){var i
let s=e.prototype
for(;s;){let e=null==(i=be.get(s))?void 0:i.get(t)
if(e)return e
s=s.prototype}}(e.constructor,t)
i&&Object.defineProperty(e,t,{enumerable:i.enumerable,configurable:i.configurable,writable:i.writable,value:i.initializer?i.initializer.call(e):void 0})}const ke=Symbol.for("LegacyPromiseProxy"),Se=_e
class Ae extends Se{constructor(...e){super(...e),le(this,ke,!0)}get id(){const{key:e,legacySupport:t}=this._belongsToState
return t.referenceFor("belongsTo",e).id()}get meta(){}async reload(e){const{key:t,legacySupport:i}=this._belongsToState
return await i.reloadBelongsTo(t,e),this}}we((F=Ae).prototype,"id",[H.PO]),we(F.prototype,"meta",[(0,U.computed)()])
class Me{constructor(e,t){le(this,ke,!0),this._update(e,t),this.isDestroyed=!1}get length(){return this["[]"],this.content?this.content.length:0}forEach(e){this.content&&this.length&&this.content.forEach(e)}reload(e){return this.content.reload(e),this}then(e,t){return this.promise.then(e,t)}catch(e){return this.promise.catch(e)}finally(e){return this.promise.finally(e)}destroy(){this.isDestroyed=!0,this.content=null,this.promise=null}get links(){return this.content?this.content.links:void 0}get meta(){return this.content?this.content.meta:void 0}_update(e,t){void 0!==t&&(this.content=t),this.promise=function(e,t){return e.isPending=!0,e.isSettled=!1,e.isFulfilled=!1,e.isRejected=!1,Promise.resolve(t).then((t=>(e.isPending=!1,e.isFulfilled=!0,e.isSettled=!0,e.content=t,t)),(t=>{throw e.isPending=!1,e.isFulfilled=!1,e.isRejected=!0,e.isSettled=!0,t}))}(this,e)}static create({promise:e,content:t}){return new this(e,t)}}we((I=Me).prototype,"length",[H.Vv]),we(I.prototype,"links",[H.Vv]),we(I.prototype,"meta",[H.Vv]),(0,W.sg)(Me.prototype,"content",null),(0,W.sg)(Me.prototype,"isPending",!1),(0,W.sg)(Me.prototype,"isRejected",!1),(0,W.sg)(Me.prototype,"isFulfilled",!1),(0,W.sg)(Me.prototype,"isSettled",!1)
{const e={enumerable:!0,configurable:!1,get:function(){return this.content?.length&&this.content}};(0,H.Vv)(e),Object.defineProperty(Me.prototype,"[]",e)}class Ce{constructor(e,t,i,s,r){le(this,"___token",void 0),le(this,"___identifier",void 0),le(this,"___relatedTokenMap",void 0),this.graph=t,this.key=r,this.hasManyRelationship=s,this.type=s.definition.type,this.store=e,this.___identifier=i,this.___token=e.notifications.subscribe(i,((e,t,i)=>{"relationships"===t&&i===r&&this._ref++})),this.___relatedTokenMap=new Map}destroy(){this.store.notifications.unsubscribe(this.___token),this.___relatedTokenMap.forEach((e=>{this.store.notifications.unsubscribe(e)})),this.___relatedTokenMap.clear()}get identifiers(){this._ref
...
return t&&t.meta&&"object"==typeof t.meta&&(e=t.meta),e}async push(e,t){const{store:i}=this,s=Array.isArray(e)?{data:e}:e,r=Array.isArray(s.data)&&s.data.length>0&&Ee(s.data[0]),n=Array.isArray(s.data)?r?i._push(s,!0):s.data.map((e=>i.identifierCache.getOrCreateRecordIdentifier(e))):[],{identifier:o}=this.hasManyRelationship,a={}
...
return this.hasManyRelationship.definition.isAsync||Fe(this.store,this._resource())?t.getHasMany(this.key,e):t.reloadHasMany(this.key,e)}reload(e){return Oe.get(this.___identifier).reloadHasMany(this.key,e)}}function Ee(e){return Object.keys(e).filter((e=>"id"!==e&&"type"!==e&&"lid"!==e)).length>0}function Te(e){return Boolean(e&&e.links&&e.links.related)}we(Ce.prototype,"identifiers",[H.Vv,H.PO]),(0,W.sg)(Ce.prototype,"_ref",0)
class qe{constructor(e,t,i,s,r){this.graph=t,this.key=r,this.belongsToRelationship=s,this.type=s.definition.type,this.store=e,this.___identifier=i,this.___relatedToken=null,this.___token=e.notifications.subscribe(i,((e,t,i)=>{"relationships"===t&&i===r&&this._ref++}))}destroy(){this.store.notifications.unsubscribe(this.___token),this.___token=null,this.___relatedToken&&(this.store.notifications.unsubscribe(this.___relatedToken),this.___relatedToken=null)}get identifier(){this.___relatedToken&&(this.store.notifications.unsubscribe(this.___relatedToken),this.___relatedToken=null)
...
return e&&e.links?e.links:null}meta(){let e=null
const t=this._resource()
return t&&t.meta&&"object"==typeof t.meta&&(e=t.meta),e}_resource(){return this._ref,this.store.cache.getRelationship(this.___identifier,this.key)}remoteType(){return Te(this._resource())?"link":"id"}async push(e,t){const{store:i}=this,s=e.data&&Ee(e.data)?i._push(e,!0):e.data?i.identifierCache.getOrCreateRecordIdentifier(e.data):null,{identifier:r}=this.belongsToRelationship,n={}
...
return this.belongsToRelationship.definition.isAsync||Fe(this.store,this._resource())?t.getBelongsTo(this.key,e):t.reloadBelongsTo(this.key,e).then((()=>this.value()))}reload(e){return Oe.get(this.___identifier).reloadBelongsTo(this.key,e).then((()=>this.value()))}}we(qe.prototype,"identifier",[H.Vv,H.PO]),(0,W.sg)(qe.prototype,"_ref",0)
const Oe=(0,Q.L1)("LEGACY_SUPPORT",new Map)
function De(e){const t=(0,k.o)(e)
let i=Oe.get(t)
return i||(i=new je(e),Oe.set(t,i),Oe.set(e,i)),i}class je{constructor(e){this.record=e,this.store=(0,k.fV)(e),this.identifier=(0,k.o)(e),this.cache=(0,k.oX)(e)
{const e=(0,oe.A)(i(151)).graphFor
this.graph=e(this.store)}this._manyArrayCache=Object.create(null),this._relationshipPromisesCache=Object.create(null),this._relationshipProxyCache=Object.create(null),this._pending=Object.create(null),this.references=Object.create(null)}_syncArray(e){if(this.isDestroyed||this.isDestroying)return
const t=e[k.u2],i=this.identifier,[s,r]=this._getCurrentState(i,e.key)
r.meta&&(e.meta=r.meta),r.links&&(e.links=r.links),t.length=0,(0,k.RX)(t,s)}mutate(e){this.cache.mutate(e)}_findBelongsTo(e,t,i,s){return this._findBelongsToByJsonApiResource(t,this.identifier,i,s).then((t=>Ne(this,e,i,t)),(t=>Ne(this,e,i,null,t)))}reloadBelongsTo(e,t){const i=this._relationshipPromisesCache[e]
if(i)return i
...
return this._updatePromiseProxyFor("belongsTo",e,{promise:i,content:s?o._instanceCache.getRecord(n):null,_belongsToState:c})}return null===n?null:o._instanceCache.getRecord(n)}setDirtyBelongsTo(e,t){return this.cache.mutate({op:"replaceRelatedRecord",record:this.identifier,field:e,value:(i=t,i?(0,k.o)(i):null)},!0)
...
if(t||(t=this.graph.get(this.identifier,e).definition),!i){const[s,r]=this._getCurrentState(this.identifier,e)
i=new de({store:this.store,type:t.type,identifier:this.identifier,cache:this.cache,identifiers:s,key:e,meta:r.meta||null,links:r.links||null,isPolymorphic:t.isPolymorphic,isAsync:t.isAsync,_inverseIsAsync:t.inverseIsAsync,manager:this,isLoaded:!t.isAsync,allowMutation:!0}),this._manyArrayCache[e]=i}return i}}fetchAsyncHasMany(e,t,i,s){{let r=this._relationshipPromisesCache[e]
if(r)return r
const n=this.cache.getRelationship(this.identifier,e),o=this._findHasManyByJsonApiResource(n,this.identifier,t,s)
return o?(r=o.then((()=>Ne(this,e,t,i)),(s=>Ne(this,e,t,i,s))),this._relationshipPromisesCache[e]=r,r):(i.isLoaded=!0,Promise.resolve(i))}}reloadHasMany(e,t){{const i=this._relationshipPromisesCache[e]
if(i)return i
...
return s?s._update(e,r):s=this._relationshipProxyCache[t]=new Me(e,r),s}if(s){const{promise:e,content:t}=i
void 0!==t&&s.set("content",t),s.set("promise",e)}else s=Ae.create(i),this._relationshipProxyCache[t]=s
return s}referenceFor(e,t){let i=this.references[t]
if(!i){const{graph:e,identifier:s}=this,r=e.get(s,t),n=r.definition.kind
"belongsTo"===n?i=new qe(this.store,e,s,r,t):"hasMany"===n&&(i=new Ce(this.store,e,s,r,t)),this.references[t]=i}return i}_findHasManyByJsonApiResource(e,t,i,s={}){{if(!e)return
const{definition:r,state:n}=i;(0,X.upgradeStore)(this.store)
const o=this.store.adapterFor?.(r.type),{isStale:a,hasDematerializedInverse:l,hasReceivedData:c,isEmpty:d,shouldForceReload:h}=n,u=Fe(this.store,e),f=e.data,p=e.links&&e.links.related&&("function"==typeof o?.findHasMany||void 0===f)&&(h||l||a||!u&&!d),y=this.store.schema.fields({type:r.inverseType}).get(r.key),m={useLink:p,field:y,links:e.links,meta:e.meta,options:s,record:t}
if(p){const t=y.options.linksMode?{url:Pe(e),op:"findHasMany",method:"GET",records:f||[],data:m,[ee._q]:!1}:{op:"findHasMany",records:f||[],data:m,cacheOptions:{[Symbol.for("wd:skip-cache")]:!0}}
...
const n=e.data?e.data:null,{isStale:o,hasDematerializedInverse:a,hasReceivedData:l,isEmpty:c,shouldForceReload:d}=i.state,h=Fe(this.store,e),u=e.links?.related&&(d||a||o||!h&&!c),f=this.store.schema.fields(this.identifier).get(i.definition.key),p={useLink:u,field:f,links:e.links,meta:e.meta,options:s,record:t}
if(u){const t=f.options.linksMode?{url:Pe(e),op:"findBelongsTo",method:"GET",records:n?[n]:[],data:p,[ee._q]:!1}:{op:"findBelongsTo",records:n?[n]:[],data:p,cacheOptions:{[Symbol.for("wd:skip-cache")]:!0}},i=this.store.request(t)
...
i.destroy&&i.destroy()})),e=this.references,this.references=Object.create(null),Object.keys(e).forEach((t=>{e[t].destroy()})),this.isDestroyed=!0}}function Pe(e){const t=e.links?.related
return"object"==typeof t?t.href:t}function Ne(e,t,i,s,r){delete e._relationshipPromisesCache[t],i.state.shouldForceReload=!1
const n="hasMany"===i.definition.kind
if(n&&s.notify(),r){i.state.hasFailedLoadAttempt=!0
const s=e._relationshipProxyCache[t]
throw s&&!n&&(s.content&&s.content.isDestroying&&s.set("content",null),e.store.notifications._flush()),r}return n?s.isLoaded=!0:e.store.notifications._flush(),i.state.hasFailedLoadAttempt=!1,i.state.isStale=!1,n||!s?s:e.store.peekRecord(s)}function Fe(e,t){const i=e._instanceCache,s=t.data
return Array.isArray(s)?s.every((e=>i.recordIsLoaded(e))):!s||i.recordIsLoaded(s)}const Ie=Y()
var $e=new WeakMap,xe=new WeakMap
class ze extends Ie{constructor(...e){super(...e),ae(this,$e,void Re(this,"messages")),ae(this,xe,void Re(this,"isEmpty"))}get errorsByAttributeName(){return new Map}errorsFor(e){const t=this.errorsByAttributeName
let i=t.get(e)
...
e.forEach((function(e,i){t.push(i)})),e.clear(),t.forEach((e=>{this.notifyPropertyChange(e)})),this.__record.currentState.notify("isValid"),super.clear()}has(e){return this.errorsFor(e).length>0}}function Le(e,t,i,s){if("belongsTo"===s.kind)i.notifyPropertyChange(t)
else if("hasMany"===s.kind){const r=Oe.get(e),n=r&&r._manyArrayCache[t],o=r&&r._relationshipPromisesCache[t]
if(n&&o)return
n&&(n.notify(),s.options.async&&i.notifyPropertyChange(t))}}function Be(e,t,i,s){(0,ne.cacheFor)(s,i)!==e.cache.getAttr(t,i)&&s.notifyPropertyChange(i)}we(($=ze).prototype,"errorsByAttributeName",[(0,U.computed)()]),ve($.prototype,"messages",[(0,Z.mapBy)("content","message")]),we($.prototype,"content",[(0,U.computed)()]),ve($.prototype,"isEmpty",[(0,Z.not)("length")])
const Ue=/^\/?data\/(attributes|relationships)\/(.*)/,Ve=/^\/?data/
function He(e){return!!e&&e instanceof Error&&"isAdapterError"in e&&!0===e.isAdapterError&&"code"in e&&"InvalidError"===e.code}function We(e,t,i){const s=i.get,r=i.set
return i.get=function(){const e=(0,W.V1)(this,t,!0)
return(0,W.B1)(e),e.shouldReset&&(e.shouldReset=!1,e.lastValue=s.call(this)),e.lastValue},i.set=function(e){(0,W.V1)(this,t,!0),r.call(this,e)},(0,H.Vv)(i),i}function Ke(e,t){const i=(0,W.i$)(e,t)
i&&(i.shouldReset=!0,(0,W.RH)(i))}class Ge{constructor(e){const t=(0,R.fV)(e),i=(0,k.o)(e)
...
const s=t.getRequestStateService(),r=t.notifications,n=e=>{if("mutation"===e.type)switch(e.state){case"pending":this.isSaving=!0
break
case"rejected":this.isSaving=!1,this._lastError=e,e.response&&He(e.response.data)||this._errorRequests.push(e),Je(this)
break
...
break
case"rejected":this.pendingCount--,this._lastError=e,e.response&&He(e.response.data)||this._errorRequests.push(e),this.notify("isLoading"),Je(this)
break
...
s.subscribeForRecord(i,n)
const o=s.getLastRequestForRecord(i)
o&&n(o),this.handler=r.subscribe(i,((e,t,i)=>{switch(t){case"state":this.notify("isSaved"),this.notify("isNew"),this.notify("isDeleted"),this.notify("isDirty")
break
case"attributes":this.notify("isEmpty"),this.notify("isDirty")
break
case"errors":this.updateInvalidErrors(this.record.errors),this.notify("isValid")}}))}destroy(){(0,R.fV)(this.record).notifications.unsubscribe(this.handler)}notify(e){Ke(this,e)}updateInvalidErrors(e){const t=this.cache.getErrors(this.identifier)
e.clear()
for(let i=0;i<t.length;i++){const s=t[i]
if(s.source&&s.source.pointer){const t=s.source.pointer.match(Ue)
let i
if(t?i=t[2]:-1!==s.source.pointer.search(Ve)&&(i="base"),i){const t=s.detail||s.title
...
return e?"rejected"===e.state&&e.response.data:null}get isPreloaded(){return!this.isEmpty&&this.isLoading}get stateName(){return this.isLoading?"root.loading":this.isEmpty?"root.empty":this.isDeleted?this.isSaving?"root.deleted.inFlight":this.isSaved?"root.deleted.saved":this.isValid?"root.deleted.uncommitted":"root.deleted.invalid":this.isNew?this.isSaving?"root.loaded.created.inFlight":this.isValid?"root.loaded.created.uncommitted":"root.loaded.created.invalid":this.isSaving?"root.loaded.updated.inFlight":this.isValid?this.isDirty?"root.loaded.updated.uncommitted":"root.loaded.saved":"root.loaded.updated.invalid"}get dirtyType(){return this.isLoading||this.isEmpty?"":this.isDirty&&this.isDeleted?"deleted":this.isNew?"created":this.isSaving||!this.isValid||this.isDirty?"updated":""}}function Je(e){e.notify("isValid"),e.notify("isError"),e.notify("adapterError")}function Ye(e,t,i){const s=new WeakMap,r=i.get
return i.get=function(){let e=s.get(this)
return e||(e={hasComputed:!1,value:void 0},s.set(this,e)),e.hasComputed||(e.value=r.call(this),e.hasComputed=!0),e.value},i}we((x=Ge).prototype,"isLoading",[We]),we(x.prototype,"isLoaded",[We]),we(x.prototype,"isSaved",[We]),we(x.prototype,"isEmpty",[We]),we(x.prototype,"isNew",[We]),we(x.prototype,"isDeleted",[We]),we(x.prototype,"isValid",[We]),we(x.prototype,"isDirty",[We]),we(x.prototype,"isError",[We]),we(x.prototype,"adapterError",[We]),we(x.prototype,"isPreloaded",[H.PO]),we(x.prototype,"stateName",[H.PO]),we(x.prototype,"dirtyType",[H.PO]),(0,W.sg)(Ge.prototype,"isSaving",!1)
class Ze extends(V()){init(e){const t=e._createProps,i=e._secretInit
...
this.___private_notifications=n.subscribe(r,((e,t,i)=>{!function(e,t,i,s,r){if("attributes"===t)i?Be(r,e,i,s):s.eachAttribute((t=>{Be(r,e,t,s)}))
else if("relationships"===t)if(i){const t=s.constructor.relationshipsByName.get(i)
Le(e,i,s,t)}else s.eachRelationship(((t,i)=>{Le(e,t,s,i)}))
else"identity"===t&&s.notifyPropertyChange("id")}(e,t,i,this,s)}))}destroy(){const e=(0,R.o)(this)
this.___recordState?.destroy(),(0,R.fV)(this).notifications.unsubscribe(this.___private_notifications),this.eachRelationship(((e,t)=>{"belongsTo"===t.kind&&this.notifyPropertyChange(e)})),Oe.get(this)?.destroy(),Oe.delete(this),Oe.delete(e),super.destroy()}get isEmpty(){return this.currentState.isEmpty}get isLoading(){return this.currentState.isLoading}get isLoaded(){return this.currentState.isLoaded}get hasDirtyAttributes(){return this.currentState.isDirty}get isSaving(){return this.currentState.isSaving}get isDeleted(){return this.currentState.isDeleted}get isNew(){return this.currentState.isNew}get isValid(){return this.currentState.isValid}get dirtyType(){return this.currentState.dirtyType}get isError(){return this.currentState.isError}set isError(e){}get id(){return(0,R.o)(this).id}set id(e){const t=(0,k.pG)(e),i=(0,R.o)(this),s=t!==i.id
null!==t&&s&&(this.store._instanceCache.setRecordId(i,t),this.store.notifications.notify(i,"identity"))}toString(){return`<model::${this.constructor.modelName}:${this.id}>`}get currentState(){return this.___recordState||(this.___recordState=new Ge(this)),this.___recordState}set currentState(e){throw new Error("cannot set currentState")}get errors(){const e=ze.create({__record:this})
...
return this.eachComputedProperty(((t,i)=>{Xe(i)&&e[i.kind].push(t)})),e}static get relatedTypes(){const e=[],t=this.relationshipsObject,i=Object.keys(t)
...
return this.modelName,this.eachComputedProperty(((t,i)=>{Xe(i)&&(i.key=t,i.name=t,e[t]=i)})),e}static get fields(){const e=new Map
return this.eachComputedProperty(((t,i)=>{Xe(i)?e.set(t,i.kind):Qe(i)&&e.set(t,"attribute")})),e}static eachRelationship(e,t){this.relationshipsByName.forEach(((i,s)=>{e.call(t,s,i)}))}static eachRelatedType(e,t){const i=this.relatedTypes
...
return this.eachComputedProperty(((t,i)=>{Qe(i)&&(i.key=t,i.name=t,e.set(t,i))})),e}static get transformedAttributes(){const e=new Map
return this.eachAttribute(((t,i)=>{i.type&&e.set(t,i.type)})),e}static eachAttribute(e,t){this.attributes.forEach(((i,s)=>{e.call(t,s,i)}))}static eachTransformedAttribute(e,t){this.transformedAttributes.forEach(((i,s)=>{e.call(t,s,i)}))}static toString(){return`model:${this.modelName}`}}function Xe(e){return"object"==typeof e&&null!==e&&"kind"in e&&"options"in e&&("hasMany"===e.kind||"belongsTo"===e.kind)}function Qe(e){return"object"==typeof e&&null!==e&&"kind"in e&&"attribute"===e.kind}we((z=Ze).prototype,"isEmpty",[H.Vv]),we(z.prototype,"isLoading",[H.Vv]),we(z.prototype,"isLoaded",[H.Vv]),we(z.prototype,"hasDirtyAttributes",[H.Vv]),we(z.prototype,"isSaving",[H.Vv]),we(z.prototype,"isDeleted",[H.Vv]),we(z.prototype,"isNew",[H.Vv]),we(z.prototype,"isValid",[H.Vv]),we(z.prototype,"dirtyType",[H.Vv]),we(z.prototype,"isError",[H.Vv]),we(z.prototype,"id",[We]),we(z.prototype,"currentState",[We]),we(z.prototype,"errors",[Ye]),we(z.prototype,"adapterError",[H.Vv]),le(Ze,"isModel",!0),le(Ze,"modelName",null),we(z,"inverseMap",[Ye]),we(z,"relationships",[Ye]),we(z,"relationshipNames",[Ye]),we(z,"relatedTypes",[Ye]),we(z,"relationshipsByName",[Ye]),we(z,"relationshipsObject",[Ye]),we(z,"fields",[Ye]),we(z,"attributes",[Ye]),we(z,"transformedAttributes",[Ye]),Ze.prototype.save=function(e){let t
return this.currentState.isNew&&this.currentState.isDeleted?t=Promise.resolve(this):(this.errors.clear(),t=this[K.pm].saveRecord(this,e)),t},Ze.prototype.destroyRecord=function(e){const{isNew:t}=this.currentState
return this.deleteRecord(),t?Promise.resolve(this):this.save(e).then((e=>(this.unloadRecord(),this)))},Ze.prototype.unloadRecord=function(){this.currentState.isNew&&(this.isDestroyed||this.isDestroying)||this[K.pm].unloadRecord(this)},Ze.prototype.hasMany=function(e){return De(this).referenceFor("hasMany",e)},Ze.prototype.belongsTo=function(e){return De(this).referenceFor("belongsTo",e)},Ze.prototype.serialize=function(e){return(0,X.upgradeStore)(this[K.pm]),this[K.pm].serializeRecord(this,e)},Ze.prototype._createSnapshot=function(){const e=this[K.pm]
if((0,X.upgradeStore)(e),!e._fetchManager){const t=(0,oe.A)(i(491)).FetchManager
e._fetchManager=new t(e)}return e._fetchManager.createSnapshot((0,R.o)(this))},Ze.prototype.deleteRecord=function(){this.currentState&&this[K.pm].deleteRecord(this)},Ze.prototype.changedAttributes=function(){return(0,k.oX)(this).changedAttrs((0,R.o)(this))},Ze.prototype.rollbackAttributes=function(){const{currentState:e}=this,{isNew:t}=e
this[K.pm]._join((()=>{(0,k.oX)(this).rollbackAttrs((0,R.o)(this)),this.errors.clear(),e.cleanErrorRequests(),t&&this.unloadRecord()}))},Ze.prototype.reload=function(e={}){e.isReloading=!0,e.reload=!0
const t=(0,R.o)(this)
return this.isReloading=!0,this[K.pm].request({op:"findRecord",data:{options:e,record:t},cacheOptions:{[Symbol.for("wd:skip-cache")]:!0}}).then((()=>this)).finally((()=>{this.isReloading=!1}))},(0,W.sg)(Ze.prototype,"isReloading",!1),Ze.prototype._createProps=null,Ze.prototype._secretInit=null
class et{constructor(e){this.store=e,this._schemas=new Map,this._typeMisses=new Set}hasTrait(e){return!1}resourceHasTrait(e,t){return!1}transformation(e){}derivation(e){}hashFn(e){}resource(e){const t=ce(e.type)
...
return!!this._schemas.has(t)||!this._typeMisses.has(t)&&!(null===tt(this.store,t)&&(this._typeMisses.add(t),1))}}function tt(e,t){e._modelFactoryCache||(e._modelFactoryCache=Object.create(null))
...
if(r){const e=Ze.extend(r)
e.__isMixin=!0,e.__mixin=r,i.register(`model:${t}`,e)}return i.factoryFor(`model:${t}`)}(e,t)),!s)return null
const r=s.class
r.isModel&&(r.modelName&&Object.prototype.hasOwnProperty.call(r,"modelName")||Object.defineProperty(r,"modelName",{value:t})),i[t]=s}return s}function it(e,t){const i=e.type,s={_createProps:t,_secretInit:{identifier:e,cache:this.cache,store:this,cb:nt}}
return(0,w.setOwner)(s,(0,w.getOwner)(this)),tt(this,i).class.create(s)}function st(e){e.destroy()}function rt(e){const t=tt(this,ce(e)),i=t&&t.class?t.class:null
if(i&&i.isModel&&!this._forceShim)return i}function nt(e,t,i,s){(0,k.TP)(e,i),k.i.set(e,s),(0,k.Wz)(e,t)}et.prototype.doesTypeExist=function(e){return(0,L.deprecate)("Use `schema.hasResource({ type })` instead of `schema.doesTypeExist(type)`",!1,{id:"ember-data:schema-service-updates",until:"6.0",for:"ember-data",since:{available:"4.13",enabled:"5.4"}}),this.hasResource({type:e})},et.prototype.attributesDefinitionFor=function(e){(0,L.deprecate)("Use `schema.fields({ type })` instead of `schema.attributesDefinitionFor({ type })`",!1,{id:"ember-data:schema-service-updates",until:"6.0",for:"ember-data",since:{available:"4.13",enabled:"5.4"}})
const t=ce(e.type)
return this._schemas.has(t)||this._loadModelSchema(t),this._schemas.get(t).attributes},et.prototype.relationshipsDefinitionFor=function(e){(0,L.deprecate)("Use `schema.fields({ type })` instead of `schema.relationshipsDefinitionFor({ type })`",!1,{id:"ember-data:schema-service-updates",until:"6.0",for:"ember-data",since:{available:"4.13",enabled:"5.4"}})
const t=ce(e.type)
return this._schemas.has(t)||this._loadModelSchema(t),this._schemas.get(t).relationships}
var ot=i(82),at=i(464)
const lt="undefined"!=typeof fetch?(...e)=>fetch(...e):"undefined"!=typeof FastBoot?(...e)=>FastBoot.require("node-fetch")(...e):()=>{throw new Error("No Fetch Implementation Found")},ct=new Set(["updateRecord","createRecord","deleteRecord"]),dt=new Map([[400,"Bad Request"],[401,"Unauthorized"],[402,"Payment Required"],[403,"Forbidden"],[404,"Not Found"],[405,"Method Not Allowed"],[406,"Not Acceptable"],[407,"Proxy Authentication Required"],[408,"Request Timeout"],[409,"Conflict"],[410,"Gone"],[411,"Length Required"],[412,"Precondition Failed"],[413,"Payload Too Large"],[414,"URI Too Long"],[415,"Unsupported Media Type"],[416,"Range Not Satisfiable"],[417,"Expectation Failed"],[419,"Page Expired"],[420,"Enhance Your Calm"],[421,"Misdirected Request"],[422,"Unprocessable Entity"],[423,"Locked"],[424,"Failed Dependency"],[425,"Too Early"],[426,"Upgrade Required"],[428,"Precondition Required"],[429,"Too Many Requests"],[430,"Request Header Fields Too Large"],[431,"Request Header Fields Too Large"],[450,"Blocked By Windows Parental Controls"],[451,"Unavailable For Legal Reasons"],[500,"Internal Server Error"],[501,"Not Implemented"],[502,"Bad Gateway"],[503,"Service Unavailable"],[504,"Gateway Timeout"],[505,"HTTP Version Not Supported"],[506,"Variant Also Negotiates"],[507,"Insufficient Storage"],[508,"Loop Detected"],[509,"Bandwidth Limit Exceeded"],[510,"Not Extended"],[511,"Network Authentication Required"]]),ht={async request(e){let t
try{t=await lt(e.request.url,e.request)}catch(e){throw e instanceof DOMException&&"AbortError"===e.name?(e.statusText="Aborted",e.status=20,e.isRequestError=!0):(e.statusText="Unknown Network Error",e.status=0,e.isRequestError=!0),e}const i=!t.ok||t.status>=400,s=e.request.op,r=Boolean(s&&ct.has(s))
if(!i&&!r&&204!==t.status&&!t.headers.has("date")){const e=new Headers(t.headers)
e.set("date",(new Date).toUTCString()),t=function(e,t){const i=(0,at.f)(e)
...
try{i=JSON.parse(n)}catch{}const s=Array.isArray(i)?i:null!==(o=i)&&"object"==typeof o&&Array.isArray(i.errors)?i.errors:null,r=t.statusText||dt.get(t.status)||"Unknown Request Error",a=`[${t.status} ${r}] ${e.request.method??"GET"} (${t.type}) - ${t.url}`,l=s?new AggregateError(s,a):new Error(a)
...
var o}}
function ut(e,t,i){return(t=function(e){var t=function(e){if("object"!=typeof e||!e)return e
var t=e[Symbol.toPrimitive]
if(void 0!==t){var i=t.call(e,"string")
if("object"!=typeof i)return i
throw new TypeError("@@toPrimitive must return a primitive value.")}return String(e)}(e)
return"symbol"==typeof t?t:t+""}(t))in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}class ft extends R.Ay{constructor(e){super(e),ut(this,"adapterFor",q),ut(this,"serializerFor",O),ut(this,"pushPayload",j),ut(this,"normalize",D),ut(this,"serializeRecord",P),"requestManager"in this||(this.requestManager=new ot.Ay,this.requestManager.use([C,ht])),this.requestManager.useCache(R.lL)}createSchemaService(){return new et(this)}createCache(e){return new n(e)}instantiateRecord(e,t){return it.call(this,e,t)}teardownRecord(e){st.call(this,e)}modelFor(e){return rt.call(this,e)||super.modelFor(e)}destroy(){N.call(this),super.destroy()}}},241:(e,t,i)=>{i.d(t,{ZH:()=>s.h,_k:()=>s.f,z9:()=>s.j})
...
return this.tokens.push(i),this.tokens.scheduleTitleUpdate(),""}willDestroy(){super.willDestroy(),this.tokens.remove(this.tokenId),this.tokens.scheduleTitleUpdate()}},n=(0,o._)(r.prototype,"tokens",[s],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),r)},274:(e,t,i)=>{i.d(t,{J4:()=>s.n,RX:()=>s.l,TP:()=>s.o,To:()=>s.A,Wz:()=>s.t,XK:()=>s.M,di:()=>s.u,fV:()=>s.s,i:()=>s.q,o:()=>s.r,oX:()=>s.p,oz:()=>s.I,pG:()=>s.g,u2:()=>s.k,xm:()=>s.i})
var s=i(70)},299:(e,t,i)=>{i.r(t),i.d(t,{default:()=>g})
...
function l(e,t){return t}function c(e){return a[`(transient) ${e}`]??null}function d(e,t){return a[`(transient) ${e}`]=t}function h(e,t){return t}function u(e){return n[`(transient) ${e}`]??null}function f(e,t){return n[`(transient) ${e}`]=t}o.__warpDrive_hasOtherCopy=!0},388:(e,t,i)=>{i.r(t),i.d(t,{default:()=>y})
var s=i(389),r=i(806),n=i.n(r),o=i(123),a=i(735),l=i(241),c=i(730)
const d=new WeakMap,h=new WeakMap
function u(){const e={},t=[],i=(0,c.o)(this),s=this.store.schema.fields(i),r={name:"Attributes",properties:["id"],expand:!0},n=r.properties,o=[r]
...
class p extends(n()){constructor(...e){var t,i
super(...e),t=f,i=void function(e,t){let i=function(e,t){var i
let s=e.prototype
for(;s;){let e=null==(i=d.get(s))?void 0:i.get(t)
if(e)return e
s=s.prototype}}(e.constructor,t)
i&&Object.defineProperty(e,t,{enumerable:i.enumerable,configurable:i.configurable,writable:i.writable,value:i.initializer?i.initializer.call(e):void 0})}(this,"store"),function(e,t){if(t.has(e))throw new TypeError("Cannot initialize the same private elements twice on an object")}(this,t),t.set(this,i)}getFilters(){return[{name:"isNew",desc:"New"},{name:"isModified",desc:"Modified"},{name:"isClean",desc:"Clean"}]}_nameToClass(e){return this.store.modelFor(e)}watchModelTypes(e,t){const{store:i}=this,s=function(e){let t=h.get(e)
return void 0===t&&(t=new Map,h.set(e,t)),t}(i),r=i.notifications.subscribe("resource",((r,o)=>{"added"===o&&this.watchTypeIfUnseen(i,s,r.type,e,t,n)})),n=[()=>{i.notifications.unsubscribe(r)}]
...
s||(s=new Map,d.set(e,s)),s.set(t,i)}(e,t,s)}(p.prototype,"store",[(0,a.inject)("store")])
const y=p},411:(e,t,i)=>{i.r(t),i.d(t,{ModuleRegistry:()=>m,default:()=>g})
...
return t&&t.default&&(t=t.default),t}}function _(e,t){if(!t)throw new Error(e)}y(g,"moduleBasedResolver",!0)},464:(e,t,i)=>{i.d(t,{I:()=>p,b:()=>b,c:()=>h,e:()=>_,f:()=>R,g:()=>u,s:()=>f,u:()=>v})
var s=i(375),r=i(648)
